                ...
                <Grid container>
                    ...
                    <Grid xs={6}>
                        ...
                        >
                            ...
                            <Button sx={{ width: 60, height: 50, top: "150px", left: "190px" }} color="primary" variant="contained" value="DC" onClick={searcher}>DC</Button>
                            <Button sx={{ width: 60, height: 50, top: "150px", left: "250px" }} color="primary" variant="contained" value="DC" onClick={searcher}>DC</Button>
